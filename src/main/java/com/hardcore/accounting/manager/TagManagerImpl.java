...
public class TagManagerImpl implements TagManager {
    ...
    public Tag createTag(String description, Long userId) {
        ...
        com.hardcore.accounting.model.persistence.Tag newTag = com.hardcore.accounting.model.persistence.Tag.builder()
    ...
    public Tag updateTag(Tag tag) {
        com.hardcore.accounting.model.persistence.Tag updatingTag = tagP2CConverter.reverse().convert(tag);
        com.hardcore.accounting.model.persistence.Tag tagInDb = Optional.ofNullable(tagDao.getTagByTagId(tag.getId()))
                              .orElseThrow(() -> new ResourceNotFoundException(
