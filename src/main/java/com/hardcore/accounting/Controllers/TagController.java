...
public class TagController {
    ...
    public Tag createTag(@RequestBody Tag tag) {
        ...
        com.hardcore.accounting.model.common.Tag resource = tagManager.createTag(tag.getDescription(), tag.getUserId());
    ...
    public Tag getTagByTagId(@PathVariable("id") Long tagId) {
        ...
        com.hardcore.accounting.model.common.Tag tag = tagManager.getTagByTagId(tagId);
    ...
    public Tag updateTag(@PathVariable("id") Long tagId, @RequestBody Tag tag) {
        ...
        com.hardcore.accounting.model.common.Tag tagInCommon = tagC2SConverter.reverse().convert(tag);
        com.hardcore.accounting.model.common.Tag resource = tagManager.updateTag(tagInCommon);
        return tagC2SConverter.convert(resource);
    }
